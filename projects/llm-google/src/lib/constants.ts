...
export const TARGET_SAMPLE_RATE = 16000; // Gemini expects 16kHz PCM
export const WORKLET_BUFFER_SIZE = 2048; // How many 16kHz samples to buffer in worklet before sending
