...
# Execution Rules
1. **Start Immediately**: If the first item in the dialogue list has the direction "Output", you must speak that utterance IMMEDIATELY to start the conversation. Do not wait for the user.
